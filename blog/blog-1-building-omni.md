...
> 📸 **[IMAGE: hero-banner]** — A futuristic tech banner showing multiple devices connected to a central AI brain.
...
> 📸 **[IMAGE: architecture-diagram]** — Clean technical diagram showing the 3-layer agent system.
...
> 📸 **[IMAGE: agent-routing-flow]** — Flowchart showing how a user message gets classified and routed.
...
> 📸 **[IMAGE: voice-pipeline-diagram]** — Technical pipeline showing audio flow.
...
> 📸 **[IMAGE: plugin-architecture]** — Hub-and-spoke diagram of the plugin system.
...
> 📸 **[IMAGE: genui-showcase]** — Dashboard mockup showing GenUI component types.
...
> 📸 **[IMAGE: event-bus-diagram]** — Network broadcast fan-out diagram.
